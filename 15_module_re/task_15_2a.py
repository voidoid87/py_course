...
def convert_to_dict(headers, intfs):
	result = [dict(zip(headers, intf)) for intf in intfs]
	return result

if __name__ == '__main__':
	print(convert_to_dict(headers, task_15_2.parse_sh_ip_int_br('sh_ip_int_br.txt')))
